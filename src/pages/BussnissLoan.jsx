  ...
  return (
    <div className="min-h-screen bg-red-100 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <form onSubmit={handleCalculate}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              readOnly
              className="w-full p-3 bg-red-100 border border-red-300 rounded-lg focus:outline-none"
            />
          </div>
        ...
        {/* Loan Breakdown */}
        {loanBreakdown && (
          <div className="mt-6 bg-red-100 p-4 rounded-lg shadow max-w-lg w-full">
