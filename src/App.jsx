...
function App() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-100 via-white to-blue-50 p-6">
        {/* Page Title */}
        <h1 className="text-5xl md:text-6xl text-red-800 font-bold text-center mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Home Loan */}
          <div
            className="group p-8 bg-white rounded-2xl shadow-md hover:shadow-2xl hover:scale-105 transition-transform duration-300 border border-red-200"
