      ...
      <nav className="bg-white border-red-200 dark:bg-red-900">
        <div className="border border-red-500 w-full flex items-center justify-between mx-auto p-4">
          ...
          <div
            ...
            id="navbar-user"
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-red-100 rounded-lg bg-red-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-red-800 md:dark:bg-red-900 dark:border-red-700">
              <li>
                <Link
                  to="/"
              ...
              <li>
                <Link
                  to="/about"
                  className="block py-2 px-3 text-red-900 rounded-sm hover:bg-red-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-red-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-red-700"
                >
                  About
                </Link>
              </li>
